...
@synthesize contentFrame, contentView, minWidth, minHeight, preventsPositionOutsideSuperview, delegate;
...
- (id)initWithFrame:(CGRect)frame {
    CGRect frm = CGRectInset(frame, -(kSPUserResizableViewGlobalInset + kSPUserResizableViewInteractiveBorderSize/2), -(kSPUserResizableViewGlobalInset + kSPUserResizableViewInteractiveBorderSize/2));
...
- (void)setContentFrame:(CGRect)frame {
    contentFrame = frame;
    self.frame = CGRectInset(frame, -(kSPUserResizableViewGlobalInset + kSPUserResizableViewInteractiveBorderSize/2), -(kSPUserResizableViewGlobalInset + kSPUserResizableViewInteractiveBorderSize/2));
}
...
- (SPUserResizableViewAnchorPoint)anchorPointForTouchLocation:(CGPoint)touchPoint {
    ...
    CGPointSPUserResizableViewAnchorPointPair allPoints[4] = { lowerRight, lowerMiddle, middleRight, centerPoint };
...
//    }
    ...
    CGFloat cnHeight = self.contentView.frame.size.height + deltaH;
