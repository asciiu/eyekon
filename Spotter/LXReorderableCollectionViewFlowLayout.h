...
@property (strong, nonatomic, readonly) UITapGestureRecognizer *singleTapGestureRecognizer;
...
- (void)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout doubleTapIndexPath:(NSIndexPath *)indexPath;
