...
- (void)setupCollectionView {
    ...
    [self.collectionView addGestureRecognizer:_doubleTapGestureRecognizer];
...
- (void)handleDoubleTap:(UIGestureRecognizer *)gestureRecognizer {
    ...
    if ([self.delegate respondsToSelector:@selector(collectionView:layout:doubleTapIndexPath:)]) {
        [self.delegate collectionView:self.collectionView layout:self doubleTapIndexPath:indexPath];
    }
}
